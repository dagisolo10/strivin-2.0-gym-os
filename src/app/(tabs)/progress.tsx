        ...
        <Screen className="px-6 pt-8" nonScrollable>
            <FlatList
                ...
                ListHeaderComponent={
                    <Div className="gap-6">
                        <Div className="gap-3">
                            <Badge variant="outline">History & Insights</Badge>
                        ...
                        {activePlan ? (
                            <Card className="bg-background gap-4 rounded-[28px] border-0 px-5 py-5">
                                <Row className="items-start">
                                    ...
                                    <Badge variant="outline">{activePlan.days.length} days</Badge>
                                </Row>
                                <Row className="gap-3">
                        ...
                        {sessions.length === 0 ? (
                            <Card className="bg-muted/40 rounded-[28px] border-0 px-5 py-5">
                ...
                renderItem={({ item: session }) => (
                    <Card className="bg-background gap-4 rounded-[28px] border-0 px-5 py-5">
                        ...
                        {session.logs.slice(0, 4).map((log) => (
                            <Row key={log.id} className="bg-muted/40 items-start gap-3 rounded-2xl px-4 py-3">
                                <Div className="flex-1 gap-1">
                                    <P className="text-sm">{log.exercise?.name ?? "Exercise"}</P>
...
function StatCard({ label, value, suffix }: { label: string; value: string; suffix: string }) {
    return (
        <Card className="flex-1 gap-1 rounded-[28px] px-5 py-5">
